...
while true do
	...
	if setCount then
		timer = runTimer[setCount.name]
		if timer then
			timer.runCount = setCount.newCount
		else
	...
	if setTickTime then
		timer = runTimer[setTickTime.name]
		if timer then
			timer.tickTime = setTickTime.tickTime
		else
	...
	if getTickTimeFlag then
		timer = runTimer[getTickTimeFlag]
		if timer then
